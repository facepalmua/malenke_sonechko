...
<body>
    ...
    <div id="tovar-right">
        <p><label>Путь к картинке </label><input type="text" id="slider_img" name="slider_img"></p>
        <p><label>ID товара </label><input type="text" id="slider_id" name="slider_id"></p>
        <p><button id="add_image">Добавить</button></p>
    </div>
</body>
</html>